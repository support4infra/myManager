    ...
    <div class="card-block">
        <form method="POST">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="email" name="usuario" class="form-control" placeholder="usuario.segundo@email.com.br">
                </div>
                <label class="col-sm-1 col-form-label" name="nome">Nome</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" placeholder="Usuário Segundo">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select name="permissoes[]" class="form-control">
